...
export const agbAr: PolicySection[] = [
  ...
  },
  {
    ...
    body: 'أي عقد مدفوع ما بيصير سارياً إلا لما تكمل عملية شراء أو اشتراك فعلية بالتطبيق وتأكد على الأسعار والميزات وشروط الدفع المعروضة. الأسعار المعروضة هي الأسعار النهائية. بصفتنا مشروعاً صغيراً وفق المادة 6 فقرة 1 رقم 27 من قانون ضريبة القيمة المضافة النمساوي (UStG)، لا نفرض ضريبة قيمة مضافة.',
  },
  {
    heading: '٤. حق الرجوع (Widerrufsrecht)',
    body: 'كمستهلك/ة، إلك الحق أساساً بالرجوع عن عقد محتوى/خدمة رقمية خلال ١٤ يوم بدون إبداء أسباب.\n\nهاد الحق بينتهي مبكراً إذا بلّشنا بتنفيذ الخدمة بعد ما توافق صراحةً إنه نبلش قبل انتهاء مدة الـ ١٤ يوم، وبنفس الوقت تأكد إنك فاهمة إنك بهيك رح تفقد حق الرجوع. هالتأكيد الصريح بينطلب بشكل منفصل وقت عملية الشراء.',
  },
  {
  ...
  },
  {
    ...
    body: 'لأي سؤال عن هالشروط، تواصل معنا عبر: team@smartordi.eu',
  },
];
...
export const agbUk: PolicySection[] = [
  {
    heading: '1. Сфера застосування',
    body: 'Ці Загальні умови використання (AGB) застосовуються до використання застосунку "Brifo", що надається компанією Smartordi OG, Steingasse 6A, Лінц, Австрія ("ми", "постачальник"). Використовуючи застосунок, ви погоджуєтеся з цими умовами.',
  },
  {
    heading: '2. Опис послуги',
    body: 'Brifo допомагає арабськомовним батькам в Австрії розуміти шкільні листи за допомогою аналізу на основі штучного інтелекту, впорядковувати зустрічі та платежі, а також писати відповіді німецькою. Застосунок пропонує безкоштовний набір функцій; окремі додаткові функції в майбутньому можуть надаватися платно ("Premium") — актуальні послуги та ціни завжди показуються в застосунку перед покупкою.\n\nАвтоматично створені підсумки та переклади є лише допоміжним інструментом і не замінюють самостійної перевірки оригінального листа. Ми не несемо відповідальності за рішення, прийняті виключно на основі результату роботи застосунку.',
  },
  {
  ...
  },
  {
    ...
    body: 'Як споживач, ви в принципі маєте право відмовитися від договору щодо цифрового контенту/послуг протягом 14 днів без зазначення причин.\n\nЦе право припиняється достроково, якщо ми розпочали виконання послуги після того, як ви прямо погодилися на те, що ми можемо почати до закінчення терміну відмови, і одночасно підтвердили, що розумієте, що через це втрачаєте право на відмову. Таке пряме підтвердження отримується окремо під час кожного процесу покупки.',
  },
  {
    heading: '5. Термін дії та скасування підписок',
    body: 'Якщо доступ Premium пропонується як підписка, застосовуються термін дії та умови скасування, показані під час оформлення. Скасування можливе через відповідну функцію в застосунку або електронною поштою на team@smartordi.eu.',
  },
  {
    heading: '6. Обмеження відповідальності',
    body: 'Ми несемо необмежену відповідальність за умисел і грубу недбалість, а також відповідно до обов\'язкових законодавчих положень (наприклад, Закону про відповідальність за продукцію). За незначну недбалість ми відповідаємо лише в разі порушення істотних договірних зобов\'язань і в межах передбачуваної, типової для договору шкоди.\n\nBrifo надає автоматично створений аналіз; ми не гарантуємо його повноту чи точність. Щодо термінів, сум платежів та іншої обов\'язкової інформації завжди визначальним є оригінальний лист школи.',
  },
  {
    heading: '7. Зміни цих умов',
    body: 'Ми можемо змінювати ці умови з дією на майбутнє, наприклад, у разі появи нових функцій чи юридичних вимог. Про суттєві зміни ми повідомимо вас у застосунку.',
  },
  {
    heading: '8. Застосовне право та юрисдикція',
    body: 'Застосовується австрійське право, за винятком Конвенції ООН про договори міжнародної купівлі-продажу товарів. Для споживачів застосовуються обов\'язкові положення країни їхнього звичайного місця проживання, якщо вона входить до ЄС.',
  },
  {
    heading: '9. Контакти',
    body: 'З питань щодо цих умов ви можете зв\'язатися з нами за адресою: team@smartordi.eu',
  },
];
