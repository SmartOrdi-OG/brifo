...
const ar: GuideArticle[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "مهلة الدفع بالنمسا عادةً 14 يوم من تاريخ الفاتورة، إلا إذا مكتوب غير هيك. دوّري بالورقة على «zahlbar bis» أو «Fälligkeit» أو «Zahlungsziel» — هي المهلة.",
      "إذا فاتت المهلة، بتوصلك «Mahnung» (تذكير). عادةً بيجي تذكير أول وبعدين تاني. بهي المرحلة الموضوع لسا بسيط وبينحل بدفعة.",
      "إذا ضلّيتي ما دفعتي، الملف بيروح لشركة تحصيل (Inkasso) — وهون بتزيد التكاليف كتير، لأنو بينضاف رسوم تحصيل وفوائد تأخير (للمستهلكين 4% بالسنة حسب القانون). لهيك أرخص شي إنك تتصرفي بدري.",
      "أهم نصيحة: إذا ما معك تدفعي، **تواصلي مع الجهة قبل ما تفوت المهلة** واطلبي تقسيط (Ratenzahlung). معظم الشركات بتوافق، بس لازم يكون الطلب مكتوب (إيميل بيكفي). تجاهل الرسالة بيخلي المبلغ يكبر، ما بيخليه يروح.",
      "في مساعدة مجانية وسرّية: «Schuldenberatung» موجودة بكل ولاية نمساوية، معترف فيها من الدولة، وبتساعدك تنظّمي ديونك بدون مقابل.",
      "احتفظي بالفاتورة الأصلية وبإثبات الدفع (سكرين شوت من البنك بيكفي) لحد ما تتأكدي إنو الموضوع خلص.",
    ],
  },
  {
    id: "termine",
    ...
    paragraphs: [
      "موعد الدكتور: خدي معك الـ e-card دايماً. وإذا ما فيكي تروحي، ألغي قبل 24 ساعة على الأقل — في عيادات بتحاسب على الموعد الضايع.",
      "موعد بدائرة رسمية (AMS، المجستْرات، MA 35، مكتب الضرائب): خدي معك **الرسالة نفسها** وهوية سارية. الرسالة عادةً بتعدّد شو لازم تجيبي معك — جيبي كل شي مذكور، حتى لو بيبيّن مو ضروري.",
      "ما ترحي بدون موعد إذا الرسالة عم تحدد وقت — كتير دوائر ما بتستقبل بدون موعد.",
      "إذا ما فيكي تحضري، خبريهم **قبل** الموعد (تلفون أو إيميل). غياب بدون خبر ممكن تكون إلو نتايج فعلية — مثلاً عند الـ AMS ممكن يتوقف الدعم المالي مؤقتاً.",
      "اللغة: من حقك تجيبي معك حدا يترجملك. وبعض الدوائر بتأمّن مترجم إذا طلبتي مسبقاً — اسألي وقت ما تاخدي الموعد.",
      "سجّلي الموعد فوراً لما توصلك الرسالة. Brifo بيقدر يحفظه من الصورة ويذكّرك فيه.",
    ],
  },
  {
    id: "behoerdenbrief",
    ...
    paragraphs: [
      ...
      "**النقطة الأهم:** إذا ما كنتي بالبيت، الرسالة بتنحفظ بمكتب البريد (Hinterlegung) — والمهلة عادةً بتبلّش من **أول يوم صارت فيه جاهزة للاستلام**، مو من اليوم اللي رحتي جبتيها فيه. يعني ممكن تكوني خسرتي أيام وإنتي ما بتعرفي. روحي جيبيها بسرعة.",
      "ما ترمي الظرف. تاريخ الاستلام مطبوع عليه، وهو اللي بيثبت متى بلّشت المهلة.",
      "دوّري بالرسالة على كلمات: «Frist»، «binnen»، «innerhalb von» — بعدها بيكون مكتوب كم عندك وقت. مهل الاعتراض عادةً أسبوعين أو أربع أسابيع.",
