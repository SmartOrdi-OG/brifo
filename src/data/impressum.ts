...
export const impressumAr: PolicySection[] = [
  ...
  },
  {
    ...
    body: 'Brifo بيساعدك تفهم رسائل المدرسة عبر تحليل بالذكاء الاصطناعي. النتائج مش استشارة قانونية أو رسمية أو تربوية، وما بتغني عن مراجعة الرسالة الأصلية بنفسك. ما منضمن اكتمال أو دقة الملخصات المولّدة آلياً بشكل كامل.',
  },
];
